    ...
    <section class="container">
		...
		<div class="col-md-6 col-sm-6">
			...
			<div id="rep" class="datafilter">
				<label>
					Righe Pagina: 
					 <select id="numpage" name="numpage" onchange="doAction(this.value);" aria-controls="sample_1" class="form-control input-sm input-xsmall input-inline">
						<option>RIGHE:</option>
						<c:forEach items="${PageLink}" var="pageLink">
							 <option value="${pageLink.link}">
							 	${pageLink.value}
							 </option>
						</c:forEach>
					 </select>
