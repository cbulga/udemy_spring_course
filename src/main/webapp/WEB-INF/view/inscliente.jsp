	...
	<div class="portlet light bordered">
		...
		<div class="portlet-body form">
			<div class="tab-content" id="myTabContent">
				...
				<!-- Form Dati Cliente -->
				<div class="tab-pane fade${firstTabSelected ? ' show active' : '' }" id="dati" role="tabpanel" aria-labelledby="dati-tab">
				...
				<!-- Form Dati Utente -->
				<div class="tab-pane fade${secondTabSelected ? ' show active' : '' }" id="avatar" role="tabpanel" aria-labelledby="avatar-tab"> 
